...
pytest --pdb --pdbcls=IPython.terminal.debugger:Pdb --ckan-ini=test.ini --cov=ckanext.googleanalyticsbasic --disable-warnings ckanext/googleanalyticsbasic/tests/
